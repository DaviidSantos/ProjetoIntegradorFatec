...
{
    public class ResultadosAnalisesViewModel : Screen
    {
        ...
        public void Cadastrar()
        {
            try
            {
                SqlCommand command =
              new SqlCommand(
                  "INSERT INTO Resultados(numSA, tipoDeEstudo, desintegracao, dissolucao, pH, dureza, friabilidade, umidade, viscosidade, solubilidade, teorDoAtivo, teorImpurezas, particulasVisiveis, pesoMedio, karlFischer) VALUES(@NumSA, @TipoDeEstudo, @Desintegracao, @Dissolucao, @PH, @Dureza, @Friabilidade, @Umidade, @Viscosidade, @Solubilidade, @TeorDoAtivo, @TeorImpurezas, @ParticulasVisiveis, @PesoMedio, @KarlFischer)", conexaoDB);
